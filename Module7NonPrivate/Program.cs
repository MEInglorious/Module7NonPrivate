...
{
    private string adressPick = "г.Минск";
    public void Pick()
    {
...
{
    private string adressShop = "г.Минск";
    public void Shop()
    {
...
{
    string name = "Michail";
    public long phone = +375000000000;
...
class Product : Order
{
    ...
    public string nameProduct = "Клавиатура";
    public void DisplayDescription()
    {
